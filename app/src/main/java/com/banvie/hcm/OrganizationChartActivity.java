...
public class OrganizationChartActivity extends AppCompatActivity implements OnLoadItemOrganizationListener {
...
//            Log.d("rrrxxx", m);
            ...
            if (organizationChart.image_bytes != null) {
                ...
                tv_avatar.setText(Support.getFirstTextOfName(organizationChart.fullName));
            }
            if (organizationChart.id.equals(m)) {
...
//            Log.d("rrrxxx0", id);
            if (organizationChart.descendants.size() == 1) {
                ...
                if (organizationChart.image_bytes != null) {
                    ...
                    tv_avatar_1.setText(Support.getFirstTextOfName(organizationChart.fullName));
                }
                if (organizationChart.id.equals(m)) {
...
//    private void change
    ...
    private void initUI() {
        ...
        m = Constant.userInformation.userId;
    ...
    public void _setOnClickItemOrganizationListener(int position) {
        ...
        m = adapter.organizations.get(position).id;
